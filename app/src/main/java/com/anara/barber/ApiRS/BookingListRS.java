...
public class BookingListRS implements Serializable {
    ...
    private ArrayList<BookingServices> services;
    ...
    public ArrayList<BookingServices> getServices() {
        return services;
    }

    public void setServices(ArrayList<BookingServices> services) {
